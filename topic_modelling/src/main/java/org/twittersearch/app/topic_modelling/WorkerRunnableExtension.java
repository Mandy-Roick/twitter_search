...
public class WorkerRunnableExtension implements Runnable {
    ...
    public WorkerRunnableExtension (int numTopics,
    ...
    public void buildLocalTypeTopicCounts () {
        ...
        for (int doc = startDoc;
            ...
            for (int position = 0; position < tokens.size(); position++) {
                ...
                if (topic == ParallelTopicModelExtension.UNASSIGNED_TOPIC) { continue; }
    ...
    protected void sampleTopicsForOneDoc (FeatureSequence tokenSequence,
        ...
        for (int position = 0; position < docLength; position++) {
            if (oneDocTopics[position] == ParallelTopicModelExtension.UNASSIGNED_TOPIC) { continue; }
        ...
        for (int position = 0; position < docLength; position++) {
            ...
            if (oldTopic != ParallelTopicModelExtension.UNASSIGNED_TOPIC) {
            ...
            boolean alreadyDecremented = (oldTopic == ParallelTopicModelExtension.UNASSIGNED_TOPIC);
