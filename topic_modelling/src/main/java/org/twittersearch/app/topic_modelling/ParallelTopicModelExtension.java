...
public class ParallelTopicModelExtension implements Serializable {

    public static final int UNASSIGNED_TOPIC = -1;

    public static Logger logger = MalletLogger.getLogger(ParallelTopicModelExtension.class.getName());
    ...
    public ParallelTopicModelExtension (int numberOfTopics) {
        this (numberOfTopics, numberOfTopics, DEFAULT_BETA);
    }

    public ParallelTopicModelExtension (int numberOfTopics, double alphaSum, double beta) {
    ...
    public ParallelTopicModelExtension (LabelAlphabet topicAlphabet, double alphaSum, double beta)
    {
    ...
    public void sumTypeTopicCounts (WorkerRunnableExtension[] runnables) {
    ...
    public void optimizeAlpha(WorkerRunnableExtension[] runnables) {
    ...
    public void temperAlpha(WorkerRunnableExtension[] runnables) {
    ...
    public void optimizeBeta(WorkerRunnableExtension[] runnables) {
    ...
    public void estimate () throws IOException {
        ...
        WorkerRunnableExtension[] runnables = new WorkerRunnableExtension[numThreads];
        ...
        if (numThreads > 1) {
            ...
            for (int thread = 0; thread < numThreads; thread++) {
                ...
                runnables[thread] = new WorkerRunnableExtension(numTopics,
                        alpha, alphaSum, beta,
                        random, data,
            ...
            runnables[0] = new WorkerRunnableExtension(numTopics,
                    alpha, alphaSum, beta,
                    random, data,
...
// here i need to divide weight through number of types * topic count
    ...
    // TODO: use this for comparing tweets that I get as a Result from query expansion
    ...
    public static ParallelTopicModelExtension read (File f) throws Exception {

        ParallelTopicModelExtension topicModel = null;

        ObjectInputStream ois = new ObjectInputStream (new FileInputStream(f));
        topicModel = (ParallelTopicModelExtension) ois.readObject();
        ois.close();
    ...
    public static void main (String[] args) {
        ...
        try {
            ...
            ParallelTopicModelExtension lda = new ParallelTopicModelExtension (numTopics, 50.0, 0.01);
